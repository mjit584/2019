...
$(window).resize(function () {
  ...
  if (windowWidth > 1240) {
    ...
    $('p, h1, h2, h3, h4, h5, h6, .about-help, .story__subhead, .byline, .story-hero, .photo-hero, .ybr-line').css('opacity', '1');
  }
});
...
function goDark() {
  ...
  if (scrollTop >= videoTop - (videoHeight / 2) && scrollTop <= videoTop + (videoHeight / 10)) {
    ...
    $('p, h1, h2, h3, h4, h5, h6, .about-help, .story__subhead, .byline, .story-hero, .photo-hero, .ybr-line').css('opacity', '0');
