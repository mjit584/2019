...
var storyDropdown=document.getElementById('header__story-dropdown');var mainMenu=document.getElementById('main-menu');var overlay=document.getElementById("home-overlay");storyDropdown.onmouseenter=function(){storyDropdown.classList.toggle('is-active');mainMenu.classList.toggle('open');overlay.classList.toggle("overlay");}
storyDropdown.onmouseleave=function(){storyDropdown.classList.toggle('is-active');mainMenu.classList.toggle('open');overlay.classList.toggle("overlay");}
...
console.log('script start');$(document).ready(function(){$("#r-2-c-2").click(function(){console.log("clicked on PEP");$("#PEP-body").fadeIn(300);$(".container-body").css("display","none");});$("#PEP-button").click(function(){$("#PEP-body").fadeOut(300);$(".container-body").css("display","flex");});$("#r-2-c-1").click(function(){$("#passport-body").fadeIn(300);console.log("clicked on passport");$(".container-body").css("display","none");});$("#passport-button").click(function(){$("#passport-body").fadeOut(300);$(".container-body").css("display","flex");});$("#r-2-c-3").click(function(){$("#ID-body").fadeIn(300);console.log("clicked on ID");$(".container-body").css("display","none");});$("#ID-button").click(function(){$("#ID-body").fadeOut(300);$(".container-body").css("display","flex");});});var slideIndexPassport=1;showSlidesPassport(slideIndexPassport);function showSlidesPassport(n){var i;var slides=$(".mySlides-passport");var dots=$(".dot-passport");if(n>slides.length){slideIndexPassport=1}
...
var slideIndexBirthright=1;showSlidesBirthright(slideIndexBirthright);function showSlidesBirthright(n){var i;var slides=$(".mySlides-birthright");var dots=$(".dot-Birthright");if(n>slides.length){slideIndexBirthright=1}
if(n<1){slideIndexBirthright=slides.length}
for(i=0;i<slides.length;i++){slides[i].style.display="none";}
for(i=0;i<dots.length;i++){dots[i].className=dots[i].className.replace(" active","");}
slides[slideIndexBirthright-1].style.display="block";dots[slideIndexBirthright-1].className+=" active";}
